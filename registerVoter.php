...
// Add a voter into database..
function  addVoter ($studentID, $firstname, $lastname,$gender, $CourseLevel,    $conn){
	try {
		$dateadded = date('M d Y');
		
		$query = 'INSERT INTO `uchaguzi`.`regperson` 
	(`regID`, `StudentID`, `Fname`, `Lname`,`Gender`,`Class`,`password`) VALUES
	 (NULL, :StudentID, :Fname, :Lname, :Gender, :Class, :password)';
    ...
    if (isset($_POST['register'])) {
                ...
                $send = addVoter ($studentID, $firstname, $lastname, $gender, $CourseLevel,    $conn);
                    if($send == true) {
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="registerVoter.php" id="ggg1"> REGISTER VOTER</a>
                        </li>
                        <li>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Voter Regisration</h3>
                    </div>
				 ...
				 <div class="form-group">
                                ...
                                <input type="submit" class="btn btn-lg btn-info btn-block"  value="Register" name="register">
                            </fieldset>
                        </form>
                    </div>
                </div>
